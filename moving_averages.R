...
plot(abbshares, type = "l", lwd=2, col = 1, ylim = c(15, 30), 
     ...
     xaxt='n', yaxt='n')
mtext(side = 1, text = "Days", line = 2, col = "deepskyblue3", cex=1.2)
mtext(side = 2, text = "ABB Shares Price (in USD)", col = "deepskyblue3", line = 2.5, cex=1.2)
y <- movavg(abbshares, 50, "s"); lines(y, col = "red2", lwd=2)
y <- movavg(abbshares, 50, "t"); lines(y, col = "green3", lwd=2)
y <- movavg(abbshares, 50, "w"); lines(y, col = "dodgerblue3", lwd=2)
y <- movavg(abbshares, 50, "m"); lines(y, col = "cyan3", lwd=2)
y <- movavg(abbshares, 50, "e"); lines(y, col = "magenta", lwd=2)
y <- movavg(abbshares, 50, "r"); lines(y, col = "orange2", lwd=2)
grid()
legend(120, 29, c("original data", "simple", "triangular", "weighted",
                  "modified", "exponential", "running"),
       col = c("black","red2","green","dodgerblue3","cyan3","magenta","orange2"), 
